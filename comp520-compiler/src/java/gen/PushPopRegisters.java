...
public class PushPopRegisters implements AssemblyPass {

    private PushPopRegisters() { };
    ...
    public static final PushPopRegisters INSTANCE = new PushPopRegisters();
    ...
    public static void setValidRegisters(HashSet<Register> validRegisters) {
        PushPopRegisters.validRegisters = validRegisters;
    }
